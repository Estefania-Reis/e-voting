        ...
        <div class="row h-100 g-0">
            <div class="col-lg-12">
                <div class="card border-0 shadow">
                    <div class="card-header p-3 text-uppercase fs-6 fw-bold bg-light border-0 shadow-sm">Master Dadus Kandidatu</div>
                    <div class="card-body">
                        <div class="row h-100 justify-content-between p-3">
                            <div class="col-auto">
                                <button type="button" class="btn btn-success btn-rounded shadow m-1 btn-open-modal" data-bs-toggle="modal" data-bs-target="#modalDataCandidate"><i class="bi bi-plus-square"></i> Adisiona Dadus</button>
                            </div>
                            <div class="col-auto">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content border-0">
                <div class="modal-header border-0 shadow-sm bg-light">
                    <h5 class="modal-title text-uppercase fw-bold" id="modalDataCandidateLabel">Dadus Kandidatu</h5>
                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="id_wakil_calon">No Identidade Vice Kandidatu</label>
                                        </div>
                                    </div>
                                    <div class="col-lg">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="nama_wakil_calon" name="nama_wakil_calon" placeholder="Nama Wakil Calon" min="1" required>
                                            <label for="nama_wakil_calon">Naran Vice Kandidatu</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="visi" class="form-label">Vizaun</label>
                                    <input id="visi" type="hidden" name="visi">
                                    <trix-editor input="visi"></trix-editor>
                                </div>
                                <div class="mb-3">
                                    <label for="misi" class="form-label">Misaun</label>
                                    <input id="misi" type="hidden" name="misi">
                                    <trix-editor input="misi"></trix-editor>
                                </div>
                                <div class="mb-3">
                                    <label for="foto" class="form-label">Upload Foto Kandidatu</label>
                ...
                <div class="modal-footer border-0 shadow bg-light">
                    ...
                    <button type="button" class="btn btn-primary btn-simpan-edit d-none" id="btn-simpan-edit" data-id="">Salva Mudansa</button>
