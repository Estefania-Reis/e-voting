                    ...
                    <div class="card-body p-3">
                        <form action="{{ route('login') }}" method="post" id="formLogin">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="username" id="label_username">NRE / Username</label>
                                @error('username')
                            ...
                            <div class="m-3">
                                <p class="fw-bold mx-2">Login Nudar :</p>
                                <div class="form-check form-switch form-switch-lg">
                                    <input class="form-check-input" type="checkbox" id="login_as" name="login_as">
                                    <label class="form-check-label px-3 py-2" for="login_as" id="label_login_as">Eleitor</label>
                                </div>
                            </div>
                            <div class="my-4">
                                <div class="d-grid gap-2 col-lg-6 mx-auto my-1">
                                    <button type="submit" class="btn btn-rounded btn-lg btn-primary"><i class="bi bi-box-arrow-in-right"></i> Entra</button>
                                </div>
                            </div>
                            <small class="d-block text-center p-3">Sidauk Rejistu? <a href="{{ route('register') }}" class="text-decoration-none fw-bold">Rejistu Konta!</a></small>
                        </form>
                    </div>
                </div>
            </div>
